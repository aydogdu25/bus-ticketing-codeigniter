...
*/
    ...
    $config['stripe_key'] = 'YOUR_STRİPE_PUBLİC_KEY';
    $config['stripe_secret'] = 'YOUR_STRİPE_SECRET_KEY';
...
|
*/
$config['global_xss_filtering'] = TRUE; //KREDİ KARTI APİ İÇİN GÜVENLİK ÖNLEMİ
