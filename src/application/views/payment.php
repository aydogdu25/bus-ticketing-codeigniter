<link rel="stylesheet" href="assets/frontend/css/pay.css">
    <link rel="stylesheet" href="assets/frontend/css/pay_theme.css">
   ...
   <!--  <nav class="navbar navbar-expand-md navbar-dark bg-info fixed-top">
					...
					<div id="pay-invoice" class="card">
						<div class="card-body">
							...
							<form action="" class="needs-validation" method="post" novalidate="novalidate" data-stripe-publishable-key="<?php echo $this->config->item('stripe_key') ?>">
								...
								<div class="form-row">
									<div class="col-md-12">
										<label for="cc-name" class="control-label">Kartın Üzerindeki İsim</label>
										<input id="cc-name" name="cc-name" type="text" class="form-control cc-name valid" required>
										<div class="invalid-feedback">Kartın Üzerindeki İsim</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-12">
										...
										<div class="invalid-feedback">Kart Numarası</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-4">
										...
										<div class="invalid-feedback">Ay</div>
									</div>
									<div class="col-4">
										...
										<div class="invalid-feedback">Yıl</div>
									</div>
									<div class="col-4">
										...
										<div class="input-group">
											...
											<div class="invalid-feedback">Güvenlik Kodu</div>
										</div>
									</div>
								</div>
								<br>
								<div >
									<button id="payment-button" type="submit" class="btn btn-lg btn-success btn-block">
										...
										<span id="payment-button-amount">Onayla</span>
										<span id="payment-button-sending" style="display:none;">İşleniyor..</span>
									</button>
								</div>
							</form>
						</div>
    ...
    <script src="assets/frontend/js/pay.js"></script>
    <script src="assets/frontend/js/pay_theme.js"></script>
    ...
    <script>
        ...
        function stripeResponseHandler(status, response) {
            ...
            if (response.error) {
                ...
                $.post( appFilePath + "Payment/stripePost", dataPost, function(response) {
