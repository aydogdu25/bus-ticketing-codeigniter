<link href="assets/frontend/css/2+1.css" rel="stylesheet">
<div class="container">
	<div class="row g-4">
		<div class="kutu">
...
<form action="odemeyap" method="post">
	<div class="container">
		<div class="seat">
			<input type="radio" id="seat1" name="seat" value="1" disabled>
	...
	<div class="container">
		<div class="seat">
			<input type="radio" id="seat7" name="seat" value="7">
			<label for="seat7">7</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat8" name="seat" value="8">
			<label for="seat8">8</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat9" name="seat" value="9">
			<label for="seat9">9</label>
		</div>
	</div>
	<div class="container">
		<div class="seat">
			<input type="radio" id="seat10" name="seat" value="10">
			<label for="seat10">10</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat11" name="seat" value="11">
			<label for="seat11">11</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat12" name="seat" value="12">
			<label for="seat12">12</label>
		</div>
	</div>
	<div class="container">
		<div class="seat">
			<input type="radio" id="seat13" name="seat" value="13">
			<label for="seat13">13</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat14" name="seat" value="14">
			<label for="seat14">14</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat15" name="seat" value="15">
			<label for="seat15">15</label>
		</div>
	</div>
	<div class="container">
		<div class="seat">
			<input type="radio" id="seat16" name="seat" value="16">
			<label for="seat16">16</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat17" name="seat" value="17">
			<label for="seat17">17</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat18" name="seat" value="18">
			<label for="seat18">18</label>
		</div>
	</div>
	<div class="container">
		<div class="seat">
			<input type="radio" id="seat19" name="seat" value="19">
			<label for="seat19">19</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat20" name="seat" value="20">
			<label for="seat20">20</label>
		</div>
		<div class="seat">
			<input type="radio" id="seat21" name="seat" value="21">
